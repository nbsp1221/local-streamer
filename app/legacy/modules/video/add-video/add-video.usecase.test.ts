...
import type { AddVideoDependencies, AddVideoRequest } from '~/legacy/modules/video/add-video/add-video.types';
import { InternalError, ValidationError } from '~/legacy/lib/errors';
