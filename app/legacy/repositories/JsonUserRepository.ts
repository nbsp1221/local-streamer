...
import type { UpdateUserInput, UserRepository } from '~/legacy/repositories/interfaces/UserRepository';
import type { CreateUserData, PublicUser, User } from '~/legacy/types/auth';
